                ...
                <div className="container">
                    <form method="post">
                        <div className="row">
                            <div className="col-xl-7">
                                ...
                                <Accordion>
                                    <div className="andro_notice">
                                        <p>Are you a returning customer? <Accordion.Toggle as={NavLink} variant="link" eventKey="0" className="p-0 d-inline-block">Click here to login</Accordion.Toggle> </p>
                                    </div>
                                        ...
                                        <div className="andro_notice-content d-block">
                                            <div className="row">
                                                ...
                                                <div className="col-12 form-group">
                                                    <div className="checkbox pt-0">
                                                        <input type="checkbox" id="rememberMe" />
                                                        <label htmlFor="rememberMe" className="mb-0">Remember Me</label>
                                                    </div>
                                                </div>
                                                <div className="col-12">
                                                    <button type="submit" className="btn btn-sm" name="button">Login</button>
                                                </div>
                                            </div>
                                        </div>
                                    </Accordion.Collapse>
                                    {/* Coupon Code */}
                                    <div className="andro_notice">
                                        <p>Do you have a coupon code? <Accordion.Toggle as={NavLink} variant="link" eventKey="1" className="p-0 d-inline-block">Click here to apply</Accordion.Toggle> </p>
                                    </div>
                                        ...
                                        <div className="andro_notice-content  d-block">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <div className="input-group-append">
                                                    <button className="btn" type="button">Apply Code</button>
                                                </div>
                                            </div>
                                        </div>
                                    </Accordion.Collapse>
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-group col-xl-6">
                                        <label className="form-label">Street Address 1 <span className="text-danger">*</span></label>
                            ...
                            <div className="col-xl-5 checkout-billing  mt-4 mt-xl-0">
                                {/* Order Details Start */}
                                    ...
                                    <table className="andro_responsive-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr className="total">
                                                ...
                                                <td />
                                                <td> <strong>{new Intl.NumberFormat().format((this.state.priceTotal + 9.99).toFixed(2))}$</strong> </td>
                                            </tr>
